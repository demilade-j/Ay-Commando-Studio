export default function MainGrid4Hero() {
  return (
    <div className="h-170">
      ...
      <div className="h-full w-full absolute flex gap-4 text-[white] z-40 items-center justify-center flex-col">
        <h1 className="lg:text-7xl font-semibold text-center md:text-5xl text-3xl">Gallery Grid 4 Cols</h1>
        <p className="lg:text-xl text-[0.8rem]">Endless Memories</p>
      </div>
