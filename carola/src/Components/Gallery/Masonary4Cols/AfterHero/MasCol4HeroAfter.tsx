import MasCol4AftHeroGallery from "./MasCol4AftHeroGallery";

export default function MasCol4HeroAfter() {
  return (
    <div className="flex flex-col lg:gap-17 md:gap-17 gap-7 py-20 lg:px-20 md:px-20 px-5 text-sm">
        ...
        <main className="columns-4 lg:gap-4 md:gap-4 gap-1"> 
        <MasCol4AftHeroGallery/>
        </main>
    </div>
  )
}
