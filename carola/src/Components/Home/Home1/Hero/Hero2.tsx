  ...
  return (
    <div className="h-170">
      ...
      <div className="h-full w-full absolute flex gap-4 text-[white] z-40 items-center justify-center flex-col">
        <h1 className="lg:text-8xl font-semibold text-center md:text-6xl text-5xl">Timeless Locations</h1>
        <p className="lg:text-2xl md:text-[1.4rem] text-[1rem] w-[80%] text-center">Modo detracto appareat qui te.</p>
