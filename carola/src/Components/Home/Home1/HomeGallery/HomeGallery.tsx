  ...
  return (
    <div className="flex flex-col gap-8 lg:px-20 pt-15 px-7">
      ...
      <main className="flex justify-between items-center">
        <h1 className="lg:text-5xl md:text-4xl text-2xl font-[700]">
          Selected Work
        </h1>
        <button
          onClick={() => navigate("/masonaryCols3")}
          className="lg:px-4 lg:py-2 md:px-4 md:py-2 px-2 cursor-pointer py-1 text-sm rounded-sm font-semibold flex items-center justify-center bg-[rgb(74,125,109)] text-white group hover:pl-4"
        >
          View All Work{" "}
